...
export const MOCK_STUDENTS: MockStudent[] = [
  {
    id: '1', studentId: 'SAC-2026-01482', beceNumber: 'BECE-2024-GH-03921', admissionNumber: 'ADM-2026-0001',
    fullName: 'Essandoh Prince', photograph: '', form: 'Form 3', className: '3 Science A',
    programme: 'General Science', house: 'St Augustine House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-01-12', joinedDate: '2026-01-12', fraudFlags: 0, mealsThisWeek: 18,
    lastMealTime: 'Today 7:15 AM', duplicateAttempts: 0, missedValidations: 0,
    auditLogs: [{ time: '08:12 AM', event: 'Enrollment initiated' }, { time: '08:13 AM', event: 'Imported from GES' }, { time: '09:10 AM', event: 'Admission verified' }, { time: '09:30 AM', event: 'Student activated' }],
  },
  {
    id: '2', studentId: 'SAC-2026-01483', beceNumber: 'BECE-2024-GH-04102', admissionNumber: 'ADM-2026-0002',
    fullName: 'Abena Serwaa', photograph: '', form: 'Form 2', className: '2 Arts A',
    programme: 'General Arts', house: 'St Theresa House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-01-10', joinedDate: '2026-01-10', fraudFlags: 0, mealsThisWeek: 15,
    lastMealTime: 'Today 12:30 PM', duplicateAttempts: 0, missedValidations: 3,
    auditLogs: [{ time: '08:30 AM', event: 'Imported from GES' }, { time: '09:00 AM', event: 'Admission verified' }, { time: '10:15 AM', event: 'Student activated' }],
  },
  {
    id: '3', studentId: 'SAC-2026-01484', beceNumber: 'BECE-2024-GH-04563', admissionNumber: 'ADM-2026-0003',
    fullName: 'Kofi Mensah', photograph: '', form: 'Form 1', className: '1 Home Ec A',
    programme: 'Home Economics', house: 'St Francis House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-02-01', joinedDate: '2026-02-01', fraudFlags: 0, mealsThisWeek: 12,
    lastMealTime: 'Today 6:50 AM', duplicateAttempts: 0, missedValidations: 6,
    auditLogs: [{ time: '08:13 AM', event: 'Imported from GES' }, { time: '09:30 AM', event: 'Student activated' }],
  },
  {
    id: '4', studentId: 'SAC-2026-01485', beceNumber: 'BECE-2024-GH-05120', admissionNumber: 'ADM-2026-0004',
    fullName: 'Ama Adobea', photograph: '', form: 'Form 3', className: '3 Business A',
    programme: 'Business', house: 'St Augustine House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-01-15', joinedDate: '2026-01-15', fraudFlags: 0, mealsThisWeek: 17,
    lastMealTime: 'Today 7:05 AM', duplicateAttempts: 0, missedValidations: 1,
    auditLogs: [{ time: '08:12 AM', event: 'Imported from GES' }, { time: '09:15 AM', event: 'Student activated' }],
  },
  {
    id: '5', studentId: 'SAC-2026-01486', beceNumber: 'BECE-2024-GH-03211', admissionNumber: 'ADM-2026-0005',
    fullName: 'Yaw Boateng', photograph: '', form: 'Form 2', className: '2 Science B',
    programme: 'General Science', house: 'St Monica House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-01-08', joinedDate: '2026-01-08', fraudFlags: 0, mealsThisWeek: 14,
    lastMealTime: 'Today 6:30 AM', duplicateAttempts: 0, missedValidations: 4,
    auditLogs: [{ time: '08:20 AM', event: 'Imported from GES' }, { time: '10:00 AM', event: 'Student activated' }],
  },
  {
    id: '6', studentId: 'SAC-2026-01487', beceNumber: 'BECE-2024-GH-01872', admissionNumber: 'ADM-2026-0006',
    fullName: 'Akua Danso', photograph: '', form: 'Form 1', className: '1 Arts B',
    programme: 'Visual Arts', house: 'St Theresa House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-01-05', joinedDate: '2026-01-05', fraudFlags: 0, mealsThisWeek: 16,
    lastMealTime: 'Today 7:00 AM', duplicateAttempts: 1, missedValidations: 2,
    auditLogs: [{ time: '08:10 AM', event: 'Imported from GES' }, { time: '09:20 AM', event: 'Student activated' }],
  },
  {
    id: '7', studentId: 'SAC-2026-01488', beceNumber: 'BECE-2024-GH-06789', admissionNumber: 'ADM-2026-0007',
    fullName: 'Kwame Asante', photograph: '', form: 'Form 3', className: '3 Agric A',
    programme: 'Agricultural Science', house: 'St Augustine House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-01-20', joinedDate: '2026-01-20', fraudFlags: 0, mealsThisWeek: 17,
    lastMealTime: 'Today 6:50 AM', duplicateAttempts: 0, missedValidations: 1,
    auditLogs: [{ time: '08:10 AM', event: 'Imported from GES' }, { time: '09:25 AM', event: 'Student activated' }],
  },
  {
    id: '8', studentId: 'SAC-2026-01489', beceNumber: 'BECE-2024-GH-07234', admissionNumber: 'ADM-2026-0008',
    fullName: 'Efua Donkor', photograph: '', form: 'Form 2', className: '2 Science C',
    programme: 'General Science', house: 'St Francis House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-01-22', joinedDate: '2026-01-22', fraudFlags: 0, mealsThisWeek: 13,
    lastMealTime: 'Today 7:10 AM', duplicateAttempts: 0, missedValidations: 5,
    auditLogs: [{ time: '08:12 AM', event: 'Imported from GES' }, { time: '09:30 AM', event: 'Student activated' }],
  },
  {
    id: '9', studentId: 'SAC-2026-01490', beceNumber: 'BECE-2024-GH-08345', admissionNumber: 'ADM-2026-0009',
    fullName: 'Nana Yaw', photograph: '', form: 'Form 1', className: '1 Science A',
    programme: 'General Science', house: 'St Augustine House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-01-25', joinedDate: '2026-01-25', fraudFlags: 0, mealsThisWeek: 11,
    lastMealTime: 'Today 7:20 AM', duplicateAttempts: 0, missedValidations: 7,
    auditLogs: [{ time: '08:15 AM', event: 'Imported from GES' }, { time: '09:35 AM', event: 'Student activated' }],
  },
  {
    id: '10', studentId: 'SAC-2026-01491', beceNumber: 'BECE-2024-GH-09456', admissionNumber: 'ADM-2026-0010',
    fullName: 'Adwoa Poku', photograph: '', form: 'Form 3', className: '3 Home Ec B',
    programme: 'Home Economics', house: 'St Monica House', academicYear: '2025/2026',
    diningEligibility: 'enabled', cardStatus: 'issued', studentStatus: 'active', enrollmentSource: 'ges',
    reportingDate: '2026-01-28', joinedDate: '2026-01-28', fraudFlags: 0, mealsThisWeek: 19,
    lastMealTime: 'Today 7:25 AM', duplicateAttempts: 0, missedValidations: 0,
    auditLogs: [{ time: '08:20 AM', event: 'Imported from GES' }, { time: '09:40 AM', event: 'Student activated' }],
  },
]
...
export const MOCK_CARDS: MockCard[] = [
  { id: '1',  studentId: 'SAC-2026-01482', studentName: 'Essandoh Prince',cardUid: 'CARD-8832', issueDate: '2026-01-12', status: 'issued', lastUsed: 'Today 7:15 AM', validationsToday: 3, studentStatus: 'active', form: 'Form 3', diningEligibility: 'enabled', scanHistory: [{ time: '7:15 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:03 PM', hall: 'Main Refectory', result: 'Success' }, { time: '6:05 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '09:10', event: 'Card generated' }, { time: '09:12', event: 'Card activated' }] },
  { id: '2',  studentId: 'SAC-2026-01483', studentName: 'Abena Serwaa',  cardUid: 'CARD-8833', issueDate: '2026-01-10', status: 'issued', lastUsed: 'Today 12:30 PM', validationsToday: 2, studentStatus: 'active', form: 'Form 2', diningEligibility: 'enabled', scanHistory: [{ time: '7:20 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:30 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '09:00', event: 'Card generated' }, { time: '09:02', event: 'Card activated' }] },
  { id: '3',  studentId: 'SAC-2026-01484', studentName: 'Kofi Mensah',   cardUid: 'CARD-8834', issueDate: '2026-02-01', status: 'issued', lastUsed: 'Today 6:50 AM', validationsToday: 2, studentStatus: 'active', form: 'Form 1', diningEligibility: 'enabled', scanHistory: [{ time: '6:50 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:10 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '09:30', event: 'Card generated' }, { time: '09:32', event: 'Card activated' }] },
  { id: '4',  studentId: 'SAC-2026-01485', studentName: 'Ama Adobea',    cardUid: 'CARD-8835', issueDate: '2026-01-15', status: 'issued', lastUsed: 'Today 7:05 AM', validationsToday: 3, studentStatus: 'active', form: 'Form 3', diningEligibility: 'enabled', scanHistory: [{ time: '7:05 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:15 PM', hall: 'Main Refectory', result: 'Success' }, { time: '6:10 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '09:15', event: 'Card generated' }, { time: '09:17', event: 'Card activated' }] },
  { id: '5',  studentId: 'SAC-2026-01486', studentName: 'Yaw Boateng',   cardUid: 'CARD-8836', issueDate: '2026-01-08', status: 'issued', lastUsed: 'Today 6:30 AM', validationsToday: 2, studentStatus: 'active', form: 'Form 2', diningEligibility: 'enabled', scanHistory: [{ time: '6:30 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:20 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '10:00', event: 'Card generated' }, { time: '10:02', event: 'Card activated' }] },
  { id: '6',  studentId: 'SAC-2026-01487', studentName: 'Akua Danso',    cardUid: 'CARD-8837', issueDate: '2026-01-05', status: 'issued', lastUsed: 'Today 7:00 AM', validationsToday: 3, studentStatus: 'active', form: 'Form 1', diningEligibility: 'enabled', scanHistory: [{ time: '7:00 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:05 PM', hall: 'Main Refectory', result: 'Success' }, { time: '6:20 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '09:20', event: 'Card generated' }, { time: '09:22', event: 'Card activated' }] },
  { id: '7',  studentId: 'SAC-2026-01488', studentName: 'Kwame Asante',  cardUid: 'CARD-8838', issueDate: '2026-01-20', status: 'issued', lastUsed: 'Today 6:50 AM', validationsToday: 3, studentStatus: 'active', form: 'Form 3', diningEligibility: 'enabled', scanHistory: [{ time: '6:50 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:25 PM', hall: 'Main Refectory', result: 'Success' }, { time: '6:15 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '09:25', event: 'Card generated' }, { time: '09:27', event: 'Card activated' }] },
  { id: '8',  studentId: 'SAC-2026-01489', studentName: 'Efua Donkor',   cardUid: 'CARD-8839', issueDate: '2026-01-22', status: 'issued', lastUsed: 'Today 7:10 AM', validationsToday: 2, studentStatus: 'active', form: 'Form 2', diningEligibility: 'enabled', scanHistory: [{ time: '7:10 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:30 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '09:30', event: 'Card generated' }, { time: '09:32', event: 'Card activated' }] },
  { id: '9',  studentId: 'SAC-2026-01490', studentName: 'Nana Yaw',      cardUid: 'CARD-8840', issueDate: '2026-01-25', status: 'issued', lastUsed: 'Today 7:20 AM', validationsToday: 2, studentStatus: 'active', form: 'Form 1', diningEligibility: 'enabled', scanHistory: [{ time: '7:20 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:35 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '09:35', event: 'Card generated' }, { time: '09:37', event: 'Card activated' }] },
  { id: '10', studentId: 'SAC-2026-01491', studentName: 'Adwoa Poku',    cardUid: 'CARD-8841', issueDate: '2026-01-28', status: 'issued', lastUsed: 'Today 7:25 AM', validationsToday: 3, studentStatus: 'active', form: 'Form 3', diningEligibility: 'enabled', scanHistory: [{ time: '7:25 AM', hall: 'Main Refectory', result: 'Success' }, { time: '12:40 PM', hall: 'Main Refectory', result: 'Success' }, { time: '6:25 PM', hall: 'Main Refectory', result: 'Success' }], cardLogs: [{ time: '09:40', event: 'Card generated' }, { time: '09:42', event: 'Card activated' }] },
]
